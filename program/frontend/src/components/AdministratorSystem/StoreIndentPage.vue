<template>
  ...
  <el-row :gutter="20">
  <el-col :span="8">
  <el-input placeholder="请输入核销码" clearable v-model="query" disabled />
    </el-col>
    <el-button type="primary" icon="search" @click="verificate" disabled />
    <el-col :span="2"/>
    <el-col :span="4">
  ...
  <el-tabs type="border-card" class="demo-tabs"  v-loading="loading">
    ...
    <el-row :gutter="20">
      ...
      >
          ...
          <el-tag size="small">{{item.IND_CREATIONTIME}}</el-tag>
          </el-descriptions-item>
...
const sto_id=route.query.sto_id as string; 
const query=ref('');
