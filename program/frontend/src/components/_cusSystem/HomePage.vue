<template>
      ...
      <el-header style="background-color: #337ecc;">
        <el-row justify="space-between">
          ...
          <el-col :span="12" style="display: flex;justify-content: space-around;align-items: center;">
            ...
            <el-link :icon="ChatLineRound" @click="gotoChat" style="color: aliceblue;font-size: large;">聊天功能</el-link>
            ...
            <el-link :icon="MessageBox" @click="indentNav" style="color: aliceblue;font-size: large;">我的订单</el-link>
    ...
    onMounted(()=>{
      ...
      console.log('当前顾客ID',user_id.value);
      searchNav();
    })
