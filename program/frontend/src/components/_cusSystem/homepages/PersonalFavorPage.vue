    ...
    <el-card>
        ...
        <el-row :gutter="20">
            <el-col :span="8">
                ...
                >
                    <template #append>
                    <el-button @click="queryFavor" type="primary"><el-icon><search/></el-icon></el-button>
                    </template>
                </el-input>
            </el-col>
            <el-col :span="4">
            ...
            <el-col :span="8">
                ...
                <el-button  color=" #eebe77" @click="noleftCom" >售罄</el-button>
                <el-button  color=" #4e8e2f" @click="expiredCom" >过期</el-button>
            </el-col>
        </el-row>
        <!-- 列表区域 -->
        <el-table 
